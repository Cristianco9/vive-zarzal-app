...
/**
 * Controller function to render the dashboard page template.
 *
 * This function handles the request to display a dashboard page view to have access to
...
export const dashboard = async (req, res, next) => {
  try {
    ...
    const boomError = Boom.notImplemented(
      'No es posible renderizar la vista de dashboard',
      err);
    next(boomError);
  }
};