...
/**
 * Controller function to render the register advertiser form page template.
 *
 * This function handles the request to display a register advertiser form page view to have access to
 ...
 */
export const registerAdvertiserForm = async (req, res, next) => {
  try {
    ...
    // delete older cookie and render the register advertiser form page
    res.clearCookie('authentication').render('registerAdvertiserForm', {
      userFullname: userFullname,
      isAuthenticated: isAuthenticated
    });
  } catch (err) {
    const boomError = Boom.notImplemented(
      'No es posible renderizar la vista de página de registro de anunciante',
      err);
    next(boomError);
  }
};