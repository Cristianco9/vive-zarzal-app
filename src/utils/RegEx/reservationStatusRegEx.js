// ─────────────────────────────────────────────────────────────────────────────
// RESERVATION STATUS — Regular Expression Patterns
// Entity: ReservationStatus | Table: estado_reserva
// ─────────────────────────────────────────────────────────────────────────────

// Regex pattern to validate the reservation status record identifier.
// The pattern ensures the ID is a positive integer
// between 1 and 10 digits long.
export const ID = /^\d{1,10}$/;

// Regex pattern to validate the reservation status name.
// The pattern accepts Unicode letters, spaces, and hyphens,
// covering lifecycle labels such as "Pending", "Confirmed",
// "Cancelled", or "Completada" in any language.
// The name must be unique per the database constraint and
// between 2 and 50 characters long.
export const name = /^[\p{L}\s\-]{2,50}$/u;

// Regex pattern to validate the reservation status description.
